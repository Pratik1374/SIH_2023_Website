    ...
    <section className="flex flex-col lg:flex-row text-white">
      ...
      <div className="w-full p-2">
        ...
        <div className="w-full h-[65vh] lg:h-[70vh] pl-3 lg:p-9 pt-1 lg:pt-2 lg:pl-24 overflow-auto scrollbar-thin scrollbar-thumb-gray-500">
          ...
          {fileUploading ? (<div className="w-full h-full flex items-center justify-center flex-col"><h2>Wait till file upload is complete...</h2><SidebarSpinner/></div>) : (<></>)}
...
//           setNewChat(false);
//         }
//         setChatHistory([{question: "my question", answer: "my answer"}]);
...
//                 </div>
//                 <div>
//                   <p className="ml-[40px]">Files Uploaded : </p>
//                   {selectedFiles.map((file, index) => (
//                     <div key={`doc_${index}`}>
//                       <p className="ml-[40px]">{file.name}</p>
//                     </div>
//                   ))}
//                 </div>
//               </div>
